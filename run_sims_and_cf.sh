...
#SBATCH --job-name=run_sims_and_cf
...
echo "Preparing workspace for sequential Calibration + Counterfactual execution on county $COUNTY (Index $SLURM_ARRAY_TASK_ID)..."
...
echo "Pipeline (Calibration + Counterfactuals) completed for county: $COUNTY"
